...
local mappings = {
  ...
  k = {
    ...
    n = { "<cmd>GkeepNew<cr>", "New Note/List" },
    g = { "<cmd>GkeepGoto<cr>", "Goto Note" },
    c = { "<cmd>GkeepCheck<cr>", "Check Mark" },
    s = { "<cmd>GkeepSortChecked<cr>", "Sort Checked" },
    l = { "<cmd>GkeepClearChecked<cr>", "Clear Checked" },
  },
